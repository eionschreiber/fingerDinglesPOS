...
namespace fingerDinglesPOS.Controllers
{
    public class CartsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,checkoutTime,TransactionTotal")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,checkoutTime,TransactionTotal")] Cart cart)
        {
            if (ModelState.IsValid)
            {
